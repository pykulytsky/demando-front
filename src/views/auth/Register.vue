<template>
  <div class="register-main">
    <div
      ...
      class="center grid login-input content-inputs"
    >
      ...
      <vs-row>
        <vs-col w="12">
          <vs-input icon-after v-model="username" label-placeholder="Username">
            ...
            <template
              v-if="username !== '' && !validateUsername"
              #message-danger
            >
              Username not valid
            </template>
      ...
      <vs-row>
        <vs-col w="12">
          ...
          >
            ...
            <template
              v-if="!validatePassword2 && password2 !== ''"
              #message-danger
            >
    ...
    <div v-else class="email-verification">
      <div id="inbox">
        <lottie-animation
          :animationData="require('@/assets/lottie/70706-email.json')"
          :loop="true"
        />
      </div>
      <vs-alert gradient>
        <template #title> Email verification needed </template>
        Thanks for joining our service, next you have to verify your email.
        Check your inbox and follow the instruction.
      </vs-alert>
    </div>
  </div>
</template>
